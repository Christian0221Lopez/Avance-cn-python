...
print(sys.argv[0])      # Imprime "mi_script.py"
print(sys.argv[1])      # Imprime "argumento1"
print(sys.argv[2])      # Imprime "argumento2"
...
CDMX = sys.argv[0]
MatrizAdj = sys.argv[1]
MatrizInc = sys.argv[2]
...
with open(MatrizAdj,"w") as archivo:
...
with open(MatrizInc,"w") as archivo:
